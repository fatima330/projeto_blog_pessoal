...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
			...
			HttpEntity<Usuario> corpoRequisisao = new HttpEntity<Usuario>(usuarioUpdate);
		
		ResponseEntity<Usuario> corpoResposta = testRestTemplate
				.withBasicAuth("root@root.com", "rootroot")
				.exchange("/usuarios/atualizar", HttpMethod.PUT, corpoRequisisao, Usuario.class);
	...
	public void deveMostarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(null, "Ricardo Marques", "eicardo_marques@email.com.br", "ricardo123", "-"));
